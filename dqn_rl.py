...
class DQNAgent:
    ...
    def save_model(self, episode=None, reward=None):
        ...
        if reward is not None and reward > self.best_reward:
            ...
            save_path = os.path.join(self.save_dir, "best_dqn_model.pth")
...
class MultiAgentDQN:
    ...
    def get_actions(self, observations, flag_decision, eval_mode):
        # 并行获取所有智能体动作
        actions = []
    ...
    def save_training_progress(self, reward_list):
        ...
        # 保存设置
        save_path = os.path.join(self.agent.save_dir, "dqn_training_progress3.png")
